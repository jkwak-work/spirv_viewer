...
OP_MEMBERNAME: 'OpMemberName';
OP_TYPEPOINTER: 'OpTypePointer';
OP_TYPEFORWARDPOINTER: 'OpTypeForwardPointer';
...
OP_LINE: 'OpLine';
OP_STORE: 'OpStore';
OP_SOURCEEXTENSION: 'OpSourceExtension';
OP_RETURN: 'OpReturn';
...
CONFLICT_BUILTIN: 'BuiltIn';
CONFLICT_CLIPDISTANCE: 'ClipDistance';
CONFLICT_CULLDISTANCE: 'CullDistance';
CONFLICT_SUBGROUPSIZE: 'SubgroupSize';
CONFLICT_SHADERINDEXAMDX: 'ShaderIndexAMDX';
